                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 gap-10 mt-20 mx-10">
                    <div className="card w-full bg-base-100 shadow-xl"
                        ...
                        <div className="card-body">
                            <h2 className="card-title text-2xl text-primary font-bold mb-10">Fixit address
                            </h2>
                    ...
                    <div className="card w-full bg-base-100 shadow-xl"
                        ...
                        data-aos-once="false" >
                        <div className="card-body">
                            <h2 className="card-title text-2xl text-primary font-bold mb-10">Phone numbers
                            </h2>
                    ...
                    <div className="card w-full bg-base-100 shadow-xl"
                        ...
                        data-aos-once="false" >
                        <div className="card-body">
                            <h2 className="card-title text-2xl text-primary font-bold mb-10">Email address
                            </h2>
                            <p className='text-primary text-xl mb-5' >
                    ...
                    <div className="card w-full bg-base-100 shadow-xl"
                        ...
                        data-aos-once="false" >
                        <div className="card-body">
                            <h2 className="card-title text-2xl text-primary font-bold mb-10">avlabile:
                            </h2>
                            <p className='text-primary text-xl mb-5' >
